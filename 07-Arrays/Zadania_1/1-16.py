...
file_names = [
"report.docx", "presentation.pptx", "data.csv", 
"photo.jpg", "notes.txt", "invoice.pdf", "resume.docx", 
"budget.xlsx", "meeting.mp4", "schedule.pdf"
]
...
sorted_temperature = sorted(daily_temperatures, reverse = True)
